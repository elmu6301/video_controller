// em_project_final_pd_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module em_project_final_pd_mm_interconnect_1 (
		...
		input  wire [30:0] dma_0_write_master_address,                  //                    dma_0_write_master.address
	...
	wire   [30:0] dma_0_write_master_translator_avalon_universal_master_0_address;       // dma_0_write_master_translator:uav_address -> dma_0_write_master_agent:av_address
	...
	wire  [107:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> dma_0_write_master_agent:rp_data
	...
	wire   [30:0] fifo_0_in_agent_m0_address;                                            // fifo_0_in_agent:m0_address -> fifo_0_in_translator:uav_address
	...
	wire  [108:0] fifo_0_in_agent_rf_source_data;                                        // fifo_0_in_agent:rf_source_data -> fifo_0_in_agent_rsp_fifo:in_data
	...
	wire  [108:0] fifo_0_in_agent_rsp_fifo_out_data;                                     // fifo_0_in_agent_rsp_fifo:out_data -> fifo_0_in_agent:rf_sink_data
	...
	wire  [107:0] dma_0_write_master_agent_cp_data;                                      // dma_0_write_master_agent:cp_data -> router:sink_data
	...
	wire  [107:0] fifo_0_in_agent_rp_data;                                               // fifo_0_in_agent:rp_data -> router_001:sink_data
	...
	wire  [107:0] cmd_mux_src_data;                                                      // cmd_mux:src_data -> fifo_0_in_burst_adapter:sink0_data
	...
	wire  [107:0] fifo_0_in_burst_adapter_source0_data;                                  // fifo_0_in_burst_adapter:source0_data -> fifo_0_in_agent:cp_data
	...
	em_project_final_pd_mm_interconnect_1_router router (
	...
	em_project_final_pd_mm_interconnect_1_router_001 router_001 (
	...
	em_project_final_pd_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (pll_sdram_outclk1_clk),                   //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	em_project_final_pd_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (pll_sdram_outclk1_clk),                       //       clk.clk
		.reset               (fifo_0_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	em_project_final_pd_mm_interconnect_1_cmd_demux rsp_demux (
		.clk                (pll_sdram_outclk1_clk),                       //       clk.clk
		.reset              (fifo_0_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	em_project_final_pd_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (pll_sdram_outclk1_clk),                   //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
